export const faqData = [
  {
    ...
    answer:
      "NFC business cards are smart cards embedded with a chip that allows instant sharing of your contact details, social links, and business information with a simple tap on a smartphone.",
  },
  {
    question: "Do NFC cards work with all phones?",
    answer:
      "Yes! Most modern Android and iOS devices support NFC. For older phones without NFC, your card also includes a QR code for easy scanning.",
  },
  {
    question: "Can I update my digital profile later?",
    answer:
      "Absolutely. You can log in to your dashboard anytime and edit your contact info, social links, and company details — changes update instantly on your NFC card.",
  },
  {
    question: "Is there a monthly subscription fee?",
    answer:
      "No monthly fees! You pay once for your NFC card. Optional premium features like analytics or custom designs may have additional costs.",
  },
  {
    question: "Do you offer bulk or team discounts?",
    answer:
      "Yes, we offer special pricing for teams, companies, and event orders. Contact our sales team for customized bulk pricing.",
  },
  {
